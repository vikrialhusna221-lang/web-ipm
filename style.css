  ...
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .card-meta { font-size: .78rem; color: var(--muted); margin-bottom: .5rem; display: flex; gap: .75rem; flex-wrap: wrap; }
  ...
  .card-excerpt { font-size: 0.9rem; color: var(--muted); line-height: 1.65; flex-grow: 1; }
  .tag {
